const skelton = () => {
    return (
        <div className="bg-white shadow-md rounded-lg p-2 mb-2 w-full md:w-1/2">
            <div role="status" className="animate-pulse">
                ...
                <div className="h-3 my-2.5 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[540px]"></div>
                <div className="h-3 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[640px] mb-2.5 mt-2.5"></div>
